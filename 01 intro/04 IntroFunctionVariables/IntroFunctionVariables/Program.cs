...
namespace IntroChangeVariableValues
{
    internal class Program
    {
        ...
        private void ShowIntroMessage(
            string Bluetec, //1) verzin hier een naam voor deze string variable
            ??? enterAmountToExit)
        {
            Console.WriteLine(Bluetec);//gebruik hier je verzonnen naam van 1) 

            //2) zet hieronder enterAmountToExit op de ???
            Console.WriteLine("druk nu "+ 2 + " keer op enter om te stoppen");
